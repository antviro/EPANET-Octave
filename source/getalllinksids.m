...
## -*- texinfo -*-
## @deftypefn {Function File} {@var{id},@var{errorcode} =} ENlinkid2index(@var{index})
## Get the ids of all the links parting from a cellarray of sortered index (obtained previously with ENgetlinkid([]
...
function [id,errorcode] = getalllinksids(index)
  if  length(index)==1,
