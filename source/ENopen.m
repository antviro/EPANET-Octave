...
## -*- texinfo -*-
## @deftypefn {Function File} {@var{errorcode} =} ENopen (@var{fileinp}, @var{filereport}, @var{filebin})@.@*
## Opens the Epanet Toolkit (with ENopen.c).  @var{fileinp} EPANET input file (inp). At the moment fileinp should be in the working directory. Compulsory argument@.@*
...
function errorcode = ENopen(fileinp, filereport, filebin)
  switch nargin,
    case 0
    ...
    case 1
      ...
      if check_file_inp(fileinp),
        errorcode = ocENopen(fileinp, filereport, filebin);
      else
